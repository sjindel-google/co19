...
double d2 = 0x2fffffffffffff; //# 01: compile-time error

class C {
  static double d3 = 0x1fffffffffffff;
  static double d4 = 0x2fffffffffffff; //# 02: compile-time error

  double d5 = 0x1fffffffffffff;
  double d6 = 0x2fffffffffffff; //# 03: compile-time error
}

main() {
  double d7 = 0x1fffffffffffff;
  double d8 = 0x2fffffffffffff; //# 04: compile-time error
