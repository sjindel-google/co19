...
main() {
  Expect.isFalse(function is F<Null>);
  Expect.isFalse(function is F<List<Null>>);

  Expect.isTrue(function is F);
  Expect.isTrue(function is F<List>);
  Expect.isTrue(function is F<dynamic>);
  Expect.isTrue(function is F<List<dynamic>>);
}
