...
main() {
  Expect.isFalse(function is G);
  Expect.isFalse(function is G<dynamic>);
  Expect.isTrue(function is G<List<Null>>);


  Expect.isTrue(function is G<List>);
  Expect.isTrue(function is G<Null>);
  Expect.isTrue(function is G<List<dynamic>>);
}
