...
class G<X1 extends C<D>, X2 extends X1> {}

main() {
  G g1 = new G();
  Expect.isTrue(g1 is G<C<D>, C<D>>);
  Expect.isFalse(g1 is G<D,D>);

  G<D, D> g2 = new G();
  Expect.isTrue(g2 is G<C<D>, C<D>>);
  Expect.isTrue(g2 is G);

  G<C<D>, C<Null>> g3 = new G();
  Expect.isTrue(g3 is G<C<D>, C<D>>);
  Expect.isTrue(g3 is G);

  G<D, Null> g4 = new G();
  Expect.isTrue(g4 is G<C<D>, C<D>>);
