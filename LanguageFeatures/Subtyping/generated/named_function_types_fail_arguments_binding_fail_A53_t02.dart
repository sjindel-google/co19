...
class ArgumentsBindingSuper1_t02 {
  T1<B0<A, List, num>, B0<A, List, num>> m;

  ArgumentsBindingSuper1_t02(T1<B0<A, List, num>, B0<A, List, num>> value) {}
  ArgumentsBindingSuper1_t02.named(T1<B0<A, List, num>, B0<A, List, num>> value, {T1<B0<A, List, num>, B0<A, List, num>> val2}) {}
  ArgumentsBindingSuper1_t02.positional(T1<B0<A, List, num>, B0<A, List, num>> value, [T1<B0<A, List, num>, B0<A, List, num>> val2]) {}
  ArgumentsBindingSuper1_t02.short(this.m);

  void superTest(T1<B0<A, List, num>, B0<A, List, num>> val) {}
  void superTestPositioned(T1<B0<A, List, num>, B0<A, List, num>> val, [T1<B0<A, List, num>, B0<A, List, num>> val2]) {}
  void superTestNamed(T1<B0<A, List, num>, B0<A, List, num>> val, {T1<B0<A, List, num>, B0<A, List, num>> val2}) {}
  T1<B0<A, List, num>, B0<A, List, num>> get superGetter => forgetType(t0Instance);
  void set superSetter(T1<B0<A, List, num>, B0<A, List, num>> val) {}
}
...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.c1(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.c2(t1Instance, forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.c3(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.c4(t1Instance, forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.c5(forgetType(t0Instance));
  }, (e) => e is TypeError);

  // test generic class members
  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.valid().superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.valid().superTestPositioned(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.valid().superTestPositioned(forgetType(t1Instance), forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.valid().superTestNamed(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.valid().superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.valid().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.valid().superGetter;
  }, (e) => e is TypeError);

  new ArgumentsBinding2_t02<T1<B0<A, List, num>, B0<A, List, num>>>.valid().test();
}
