...
class ClassMemberTestStatic {
  static T1<B0<A, List, num>, B1<A, List, num>> s;
  ...
  static T1<B0<A, List, num>, B1<A, List, num>> get staticGetter => forgetType(t0Instance);
}
...
class ClassMemberTestPublic {
  ...
  T1<B0<A, List, num>, B1<A, List, num>> get getter => forgetType(t0Instance);
}

class ClassMemberTestPrivate {
  T1<B0<A, List, num>, B1<A, List, num>> _m;
...
class ClassMemberTestInitFail {
  static T1<B0<A, List, num>, B1<A, List, num>> s = forgetType(t0Instance);
  T1<B0<A, List, num>, B1<A, List, num>> m = forgetType(t0Instance);
}
...
main() {
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<B0<A, List, num>, B1<A, List, num>>>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<B0<A, List, num>, B1<A, List, num>>>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<T1<B0<A, List, num>, B1<A, List, num>>>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<T1<B0<A, List, num>, B1<A, List, num>>>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<B0<A, List, num>, B1<A, List, num>>>.validConstructor().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<B0<A, List, num>, B1<A, List, num>>>.validConstructor().setter = t0Instance;
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<T1<B0<A, List, num>, B1<A, List, num>>>.validConstructor().setter = t0Instance;
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<B0<A, List, num>, B1<A, List, num>>>.validConstructor().test(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<T1<B0<A, List, num>, B1<A, List, num>>>.validConstructor().test(t0Instance);
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<B0<A, List, num>, B1<A, List, num>>>.validConstructor().getter;
  }, (e) => e is TypeError);
