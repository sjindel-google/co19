...
class ClassMemberTestStatic {
  ...
  static T1<Y0, Y0> get staticGetter => forgetType(t0Instance);
}
...
class ClassMemberTestPublic {
  ...
  T1<Y0, Y0> get getter => forgetType(t0Instance);
}
...
class ClassMemberTestInitFail {
  static T1<Y0, Y0> s = forgetType(t0Instance);
  T1<Y0, Y0> m = forgetType(t0Instance);
}
...
main() {
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<Y0, Y0>>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<Y0, Y0>>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<T1<Y0, Y0>>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<T1<Y0, Y0>>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<Y0, Y0>>.validConstructor().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<Y0, Y0>>.validConstructor().setter = t0Instance;
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<T1<Y0, Y0>>.validConstructor().setter = t0Instance;
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<Y0, Y0>>.validConstructor().test(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<T1<Y0, Y0>>.validConstructor().test(t0Instance);
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ClassMemberTestGenericPublic<T1<Y0, Y0>>.validConstructor().getter;
  }, (e) => e is TypeError);
