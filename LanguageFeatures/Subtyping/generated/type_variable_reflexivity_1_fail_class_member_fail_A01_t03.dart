...
main() {
  ...
  Expect.throws(() {
    new ClassMember2_t03<C<S0>>().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<C<S0>>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<C<S0>>().test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<C<S0>>().test2();
  }, (e) => e is TypeError);
}
