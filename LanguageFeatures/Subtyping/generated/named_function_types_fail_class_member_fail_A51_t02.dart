...
main() {
  ...
  Expect.throws(() {new ClassMember2_t02<T1<Y0, Y0>>();}, (e) => e is TypeError);
  Expect.throws(() {new ClassMember2_t02<T1<Y0, Y0>>.short();}, (e) => e is TypeError);
  Expect.throws(() {new ClassMember2_t02<T1<Y0, Y0>>.named();}, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<T1<Y0, Y0>>.valid().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<T1<Y0, Y0>>.valid().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<T1<Y0, Y0>>.valid().test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<T1<Y0, Y0>>.valid().test2();
  }, (e) => e is TypeError);
}
