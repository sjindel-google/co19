...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().superTestPositioned(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().superTestPositioned(forgetType(t1Instance), forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().superTestNamed(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().superGetter;
  }, (e) => e is TypeError);

  new ArgumentsBinding2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().test();
}
