...
main() {
  ...
  Expect.throws(() {new ReturnValueGen<T1<X0<A, List, num>, X1<A, List, num>>>().testMethod();}, (e) => e is TypeError);
  Expect.throws(() {new ReturnValueGen<T1<X0<A, List, num>, X1<A, List, num>>>().testGetter;}, (e) => e is TypeError);
}
