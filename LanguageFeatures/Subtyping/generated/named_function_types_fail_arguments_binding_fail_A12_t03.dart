...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<Y0, Y1>>().superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<Y0, Y1>>().superTestPositioned(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<Y0, Y1>>().superTestPositioned(forgetType(t1Instance), forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<Y0, Y1>>().superTestNamed(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<Y0, Y1>>().superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<Y0, Y1>>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<T1<Y0, Y1>>().superGetter;
  }, (e) => e is TypeError);

  new ArgumentsBinding2_t03<T1<Y0, Y1>>().test();
}
