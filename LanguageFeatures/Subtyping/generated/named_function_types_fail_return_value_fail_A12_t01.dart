...
T1<Y0, Y1> returnValueFunc() => forgetType(t0Instance);

class ReturnValueTest {
  static T1<Y0, Y1> staticTestMethod() => forgetType(t0Instance);

  T1<Y0, Y1> testMethod() => forgetType(t0Instance);

  T1<Y0, Y1> get testGetter => forgetType(t0Instance);
}
...
main() {
  T1<Y0, Y1> returnValueLocalFunc() => forgetType(t0Instance);
  ...
  Expect.throws(() {new ReturnValueGen<T1<Y0, Y1>>().testMethod();}, (e) => e is TypeError);
  Expect.throws(() {new ReturnValueGen<T1<Y0, Y1>>().testGetter;}, (e) => e is TypeError);
}
