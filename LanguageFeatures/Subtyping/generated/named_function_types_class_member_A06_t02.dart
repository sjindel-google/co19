...
main() {
  ...
  ClassMember2_t02<T1<B0<A, List, num>, B1<A, List, num>>> c2 = new ClassMember2_t02<T1<B0<A, List, num>, B1<A, List, num>>>();
  c2 = new ClassMember2_t02<T1<B0<A, List, num>, B1<A, List, num>>>.short();
  c2 = new ClassMember2_t02<T1<B0<A, List, num>, B1<A, List, num>>>.named();
