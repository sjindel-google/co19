...
main() {
  ...
  Expect.throws(() {new ClassMember2_t02<T1<Y0, Y1>>();}, (e) => e is TypeError);
  Expect.throws(() {new ClassMember2_t02<T1<Y0, Y1>>.short();}, (e) => e is TypeError);
  Expect.throws(() {new ClassMember2_t02<T1<Y0, Y1>>.named();}, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<T1<Y0, Y1>>.valid().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<T1<Y0, Y1>>.valid().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<T1<Y0, Y1>>.valid().test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<T1<Y0, Y1>>.valid().test2();
  }, (e) => e is TypeError);
}
