...
main() {
  ...
  Expect.throws(() {
    new ClassMember2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<T1<B0<A, List, num>, B0<A, List, num>>>().test2();
  }, (e) => e is TypeError);
}
