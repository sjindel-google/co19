...
main() {
  ...
  Expect.throws(() {
    new ClassMember2_t03<T1<X0<A, List, num>, X0<A, List, num>>>().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<T1<X0<A, List, num>, X0<A, List, num>>>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<T1<X0<A, List, num>, X0<A, List, num>>>().test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<T1<X0<A, List, num>, X0<A, List, num>>>().test2();
  }, (e) => e is TypeError);
}
