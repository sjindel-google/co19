 ...
 * the T1 variable. Test that instance of T1 cannot be assigned to a local
 * variable of type T0 and TypeError is thrown
...
main() {
  Expect.throws(() {T0 t0 = forgetType(new T1());}, (e) => e is TypeError);
  Expect.throws(() {
    T0 t0 = null;
