 ...
 * the T1 variable. Test that if there is no i, such that Si <: T1, then T0 is
 * not subtype of T1 and TypeError is thrown
...
main() {
  C c = new C();
  Expect.throws(() {c.m = forgetType(new T());}, (e) => e is TypeError);
}
