 ...
 * be used as an argument of type T1. Setter argument is tested.
 * @compile-error
 * @author sgrekhov@unipro.ru
 */
/*
 * This test is generated from right_FutureOr_fail_A02.dart and 
 * arguments_binding_fail_x40.dart.
...
main() {
    new ArgumentsBindingClassGen<FutureOr<S1>>(t1Instance).testSetter = t0Instance;
}
