 ...
 * be used as an argument of type T1. Test mixin members. Super setter argument
 * is tested.
 * @compile-error
 * @author sgrekhov@unipro.ru
 ...
 * arguments_binding_mixin_fail_x36.dart.
...
main() {
  new ArgumentsBinding2_t03<C0<U0, U1, U2>>().superSetter = t0Instance;
}
