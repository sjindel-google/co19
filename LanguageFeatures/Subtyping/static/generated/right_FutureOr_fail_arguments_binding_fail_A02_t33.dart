 ...
 * be used as an argument of type T1. Factory constructor named argument is
 * tested.
 * @compile-error
 ...
 * arguments_binding_fail_x33.dart.
...
main() {
  new ArgumentsBindingClassGen<FutureOr<S1>>.fNamed(t1Instance, t2: t0Instance);
}
