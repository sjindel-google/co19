 ...
 * be used as an argument of type T1. Global generic function named argument
 * is tested.
 * @compile-error
 ...
 * arguments_binding_fail_x06.dart.
...
main() {
  namedArgumentsFunc2<FutureOr<S1>>(t1Instance, t2: t0Instance);
}
