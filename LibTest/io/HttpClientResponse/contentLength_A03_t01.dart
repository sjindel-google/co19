 ...
 * StateError.
 * @description Checks that it is an Exception if the content length is set
 * after the body is written to
...
test(String method) async {
  ...
  server.listen((HttpRequest request) {
    ...
    Expect.throws(() {request.response.contentLength = helloWorld.length;});
