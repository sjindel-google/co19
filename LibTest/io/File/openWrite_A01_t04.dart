 ...
 * file. Test WRITE_ONLY_APPEND mode
...
main() {
  ...
  IOSink sink = file.openWrite(mode: FileMode.WRITE_ONLY_APPEND);
  sink.write("прекрасна");
  asyncStart();
  sink.close().then((_) {
    try {
      Expect.equals("UTF-8: кириллица прекрасна", file.readAsStringSync());
      asyncEnd();
    } finally {
      file.delete();
    }
