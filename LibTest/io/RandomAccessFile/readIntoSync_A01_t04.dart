 ...
 * existing List<int> from the file, and if start is set and end is not set the
 * bytes are filled into buffer at index start up to buffer.length.
...
check(int start) {
  ...
  raFile.then((RandomAccessFile rf) {
    ...
    Expect.equals(list.length - start, num);
    for (int i = 0; i < num; i++) {
