 ...
 *
 * @description Checks that if no port specified the default value 1080 is used
...
test() async {
  ...
  HttpServer server = await HttpServer.bind(localhost, 1080);
  ...
  client.findProxy = (Uri url) {
    ...
    return HttpClient.findProxyFromEnvironment(url,
        environment: {"http_proxy": localhost});
  };
